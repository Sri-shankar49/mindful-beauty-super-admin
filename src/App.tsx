        ...
        <Routes>
          ...
          <Route path="/" element={<LoginLayout />}>
            <Route path="/Dashboard" element={<Dashboard />} >
              ...
              {/* Sub-routes */}
              <Route path="DashBoardData" element={<DashBoardData appointment_id={0} appointment_date={''} appointment_time={''} branch={0} user_name={''} user_phone={''} service_names={[]} branch_city={''} stylist_name={''} stylist_id={''} provider_name={''} stylist_photo={''} />} />
